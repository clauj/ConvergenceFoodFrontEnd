...
const Header = () => {
    ...
    const { data, login, userLogout, enderecos, assinaturas } = useContext(UserContext);
        ...
        <header className={styles.header}>
            <div className={styles.nav}>
                ...
                <div className={styles.loggedArea}>
                    {data?.admin === 1 && assinaturas?.length < 1 && (
                        <button onClick={() => history.push('/assine')} className={styles.assinaturaPendente}>
